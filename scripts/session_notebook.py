...
class SessionNotebook:
    ...
    def record_tool_usage(
        self, tool_name: str, purpose: str, effectiveness: str = "effective"
    ):
    ...
    def export_for_uckn(self):
        ...
        uckn_export = {
            ...
            "insights": [
                {"insight": insight["insight"], "pattern_category": "lesson_learned"}
        ...
        export_file = (
            self.project_root
            / ".taskmaster"
            / f"uckn-export-{self.current_session['session_id']}.json"
        )
        ...
        print(
            f"   Patterns: {len(uckn_export['problems_solved']) + len(uckn_export['methodologies']) + len(uckn_export['insights'])}"
        )
        return export_file
