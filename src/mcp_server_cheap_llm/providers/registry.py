...
from ..core.models import ProviderConfig, ProviderType
...
class ProviderRegistry:
    ...
    def get_provider_class(self, provider_type: ProviderType) -> type[LLMProvider]:
        ...
        if provider_type not in self._providers:
            ...
            raise ProviderError(
                f"Provider type {provider_type} not registered. Available: {available_types}",
    ...
    def create_provider(self, config: ProviderConfig) -> LLMProvider:
        ...
        try:
            ...
            raise ProviderError(
                f"Failed to create provider {config.name}: {str(e)}",
                provider=config.name,
