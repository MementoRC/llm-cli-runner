"""Configuration management for MCP Server LLM CLI Runner.
...
class ConfigModel(BaseModel):
    ...
    Example:
        >>> config = ConfigModel(
        ...     server_name="mcp-llm-cli-runner",
...
class EnvironmentLoader:
    ...
    def _validate_required_vars(self, config: dict[str, Any]) -> None:
        ...
        """
        from mcp_server_llm_cli_runner.utils.errors import ValidationError
